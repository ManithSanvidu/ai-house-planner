   ...
   <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
    <div>
     ...
     <input
      ...
      className="w-full rounded-xl border border-border-strong bg-surface px-4 py-2.5 text-sm text-gray-900 focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500 border-border bg-surface-elevated dark:text-text-primary"
     />
    </div>
