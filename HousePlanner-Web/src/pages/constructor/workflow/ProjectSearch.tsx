 ...
 return (
  <div className="rounded-2xl border border-border bg-surface shadow-sm dark:border-border-strong bg-surface mb-8 overflow-hidden">
   ...
   <div className="p-6">
    <form onSubmit={handleSearch} className="flex gap-4">
     <div className="relative flex-1">
      ...
      <input
       ...
       className="block w-full rounded-lg border border-border-strong bg-surface py-2.5 pl-10 pr-3 text-sm placeholder-gray-500 focus:border-indigo-500 focus:outline-none focus:ring-1 focus:ring-indigo-500 border-border bg-surface-elevated dark:text-text-primary dark:placeholder-gray-400 dark:focus:border-indigo-500 dark:focus:ring-indigo-500"
    ...
    {searchResult && (
     <div className="mt-6 rounded-xl border border-gray-100 bg-gray-50 p-5 dark:border-border-strong bg-surface-elevated/50">
      <h3 className="mb-4 text-sm font-medium text-gray-900 dark:text-text-primary">Project Found</h3>
      ...
      <div className="mt-6 border-t border-border pt-4 border-border">
       {requestStatus === 'idle' && (
        <button
         ...
         className="flex items-center gap-2 rounded-lg bg-indigo-600 px-4 py-2 text-sm font-medium text-text-primary shadow-sm hover:bg-indigo-500"
        >
         Request Assignment
