   ...
   <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
    <div>
     ...
     <input
      ...
      className="w-full rounded-xl border border-border-strong bg-surface px-4 py-2.5 text-sm text-gray-900 focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500 disabled:opacity-50 border-border bg-surface-elevated dark:text-text-primary"
     />
    </div>
   ...
   {!isReadOnly && (
    <div className="flex justify-end gap-3 pt-4 border-t border-border">
     <button
      ...
      onClick={onCancel}
      disabled={loading}
      className="px-4 py-2 text-sm font-medium text-gray-700 bg-surface border border-border-strong rounded-xl hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 bg-surface-elevated dark:text-gray-300 dark:border-gray-600 dark:hover:bg-gray-700"
     >
      Cancel
     </button>
     <button
