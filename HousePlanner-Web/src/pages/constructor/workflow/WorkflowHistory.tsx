  ...
  if (logs.length === 0) {
    return (
      <div className="text-center py-8">
        <p className="text-gray-500 dark:text-gray-400">No logs recorded for this project yet.</p>
      </div>
    );
  }
          ...
          <div className="w-[calc(100%-4rem)] md:w-[calc(50%-2.5rem)] p-4 rounded-2xl border border-gray-100 dark:border-gray-800 bg-white dark:bg-gray-900 shadow-sm">
            ...
            <div className="space-y-3 mt-4 text-sm">
              <div>
                ...
                <p className="text-gray-600 dark:text-gray-400 whitespace-pre-wrap">{log.completedWork}</p>
              </div>
              ...
              {log.tomorrowPlan && (
                <div className="bg-gray-50 dark:bg-gray-800/50 p-3 rounded-lg">
                  <h4 className="font-medium text-gray-900 dark:text-white mb-1">Plan for Tomorrow</h4>
                  <p className="text-gray-600 dark:text-gray-400">{log.tomorrowPlan}</p>
                </div>
              )}
            </div>
          </div>
