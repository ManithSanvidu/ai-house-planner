  ...
  return (
    <div className="p-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <Link to="/architect/requests" className="bg-white p-6 rounded-lg shadow-sm border border-gray-200 hover:border-indigo-300 hover:shadow-md transition-all cursor-pointer">
        ...
        <Link to="/architect/approved" className="bg-white p-6 rounded-lg shadow-sm border border-gray-200 hover:border-emerald-300 hover:shadow-md transition-all cursor-pointer">
          <p className="text-sm font-medium text-gray-500 mb-1">Approved</p>
          <p className="text-3xl font-bold text-emerald-600">{stats.approved}</p>
        </Link>

        <Link to="/architect/approved" className="bg-white p-6 rounded-lg shadow-sm border border-gray-200 hover:border-red-300 hover:shadow-md transition-all cursor-pointer">
