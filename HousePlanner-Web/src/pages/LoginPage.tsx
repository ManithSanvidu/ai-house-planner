      ...
      >
        <div className="bg-white dark:bg-gray-900 rounded-3xl p-8 sm:p-10 custom-shadow-xl border border-gray-100 dark:border-gray-800 relative overflow-hidden">
          ...
          <button 
            ...
            className="w-full bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-700 text-gray-700 dark:text-white font-semibold py-3.5 rounded-xl flex items-center justify-center gap-3 transition-colors mb-3"
          >
