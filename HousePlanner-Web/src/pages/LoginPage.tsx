  ...
  <div className="min-h-screen bg-background flex items-center justify-center p-6 relative overflow-hidden transition-colors">
   ...
   >
    <div className="bg-surface rounded-3xl p-8 sm:p-10 custom-shadow-xl border border-gray-100 dark:border-border-strong relative overflow-hidden">
     ...
     <div className="my-6 flex items-center before:mt-0.5 before:flex-1 before:border-t before:border-border dark:before:border-border-strong after:mt-0.5 after:flex-1 after:border-t after:border-border dark:after:border-border-strong">
      <p className="mx-4 mb-0 text-center text-xs text-text-secondary font-medium uppercase tracking-wider">
       Or
      </p>
     </div>
