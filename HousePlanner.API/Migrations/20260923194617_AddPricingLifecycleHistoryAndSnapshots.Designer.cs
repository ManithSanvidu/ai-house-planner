...
namespace HousePlanner.API.Migrations
{
    ...
    [Migration("20260923194617_AddPricingLifecycleHistoryAndSnapshots")]
    partial class AddPricingLifecycleHistoryAndSnapshots
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("HousePlanner.API.Entities.ConstructionPhase", b =>
                {
                    ...
                    b.Property<int>("AiEstimatedDurationDays")
            ...
            modelBuilder.Entity("HousePlanner.API.Entities.DailyConstructionLog", b =>
                {
                    ...
                    b.ToTable("DailyConstructionLogs");
                });
            ...
            modelBuilder.Entity("HousePlanner.API.Entities.Project", b =>
                {
                    ...
                    b.Property<int>("AiEstimatedTotalDurationDays")
                        .HasColumnType("integer");
                    ...
                    b.Property<int>("PlannedTotalDurationDays")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("HousePlanner.API.Entities.ValidationRequest", b =>
                {
                    ...
                    b.HasIndex("WorkflowStateId", "HouseDesignId", "Status")
